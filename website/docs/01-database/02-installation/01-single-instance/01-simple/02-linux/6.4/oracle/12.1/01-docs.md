...
permalink: /database/installation/single-instance/simple/linux/6.4/oracle/12.1/docs/
---

# <a href="/database/installation/single-instance/simple/linux/6.4/oracle/12.1/">[Инсталляция Oracle DataBase Server 12.1 в Oracle Linux 6.4]</a>: Официальная документация
