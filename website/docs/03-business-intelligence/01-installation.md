...
Для инсталляции Oracle BI используется сервер баз дынных, описание инсталляции которого приведено <a href="/oracle-database-installation/linux/6.3/oracle/11.2/">здесь</a>.<br/><br/>
