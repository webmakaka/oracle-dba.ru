...
Для инсталляции Oracle BI используется сервер баз дынных, описание инсталляции которого приведено <a href="/oracle_database_installation/linux/6.3/oracle/11.2/">здесь</a>.<br/><br/>
