...
permalink: /oracle_database_installation/rac/linux/5.8/oracle/11.2/autostart-only-packages-what-needed/
---

# <a href="/oracle_database_installation/rac/linux/5.8/oracle/11.2/">[Инсталляция Oracle RAC 11.2 в операционной системе Oracle Linux 5.8 x86_64]</a>: Выбор пакетов для автозапуска
