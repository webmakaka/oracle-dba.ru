...
permalink: /oracle_database_installation/linux/6.4/oracle/12.1/docs/
---

# <a href="/oracle_database_installation/linux/6.4/oracle/12.1/">[Инсталляция Oracle DataBase Server 12.1 в Oracle Linux 6.4]</a>: Официальная документация
