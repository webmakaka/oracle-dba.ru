...
permalink: /oracle-database-installation/linux/6.3/oracle/11.2/oracle-final-hot-backup/
---

# <a href="/oracle-database-installation/linux/6.3/oracle/11.2/">[Инсталляция Oracle DataBase Server 11.2.0.3 в Oracle Linux 6.3]</a>: Контрольный backup (горячий backup):
