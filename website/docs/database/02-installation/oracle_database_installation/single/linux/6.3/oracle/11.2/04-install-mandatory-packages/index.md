...
permalink: /oracle_database_installation/linux/6.3/oracle/11.2/install-mandatory-packages/
---

# <a href="/oracle_database_installation/linux/6.3/oracle/11.2/">[Инсталляция Oracle DataBase Server 11.2.0.3 в Oracle Linux 6.3]</a>:  Инсталляция обязательных пакетов
