...
permalink: /oracle-database-installation/rac/linux/5.8/oracle/11.2/environment-description/
---

# <a href="/oracle-database-installation/rac/linux/5.8/oracle/11.2/">[Инсталляция Oracle RAC 11.2 в операционной системе Oracle Linux 5.8 x86_64]</a>: Описание окружения для инсталляции Oracle RAC
