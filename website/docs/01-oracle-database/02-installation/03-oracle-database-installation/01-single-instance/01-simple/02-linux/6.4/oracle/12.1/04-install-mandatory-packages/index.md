...
permalink: /oracle-database-installation/linux/6.4/oracle/12.1/install-mandatory-packages/
---

# <a href="/oracle-database-installation/linux/6.4/oracle/12.1/">[Инсталляция Oracle DataBase Server 12.1 в Oracle Linux 6.4]</a>: Инсталляция обязательных пакетов
