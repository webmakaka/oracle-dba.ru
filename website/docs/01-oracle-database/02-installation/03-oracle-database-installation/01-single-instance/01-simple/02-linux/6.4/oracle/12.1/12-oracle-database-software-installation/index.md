...
permalink: /oracle-database-installation/linux/6.4/oracle/12.1/oracle-database-software-installation/
---

# <a href="/oracle-database-installation/linux/6.4/oracle/12.1/">[Инсталляция Oracle DataBase Server 12.1 в Oracle Linux 6.4]</a>: Инсталляция СУБД Oracle (DataBase SoftWare)
