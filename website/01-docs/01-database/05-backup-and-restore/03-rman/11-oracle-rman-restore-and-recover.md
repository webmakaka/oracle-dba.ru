...
RESTORE DATABASE PREVIEW - представляет детальный отчет обо всех резервных копиях, которые потребуются для успешного выполнения команды RESTORE.
...
### Восстанавливать до того места, где возникает ошибка (например, отсутствует архивный журнал или он испорчен).
