...
<ul>
	<li>
		<a href="//sysadm.ru/virtual/virtualbox/setup/centos/6/">Инсталляция VirtualBox на Centos 6.4 Server без графического интерфейса (GUI)</a>
	</li>
	<li>
		<a href="//sysadm.ru/virtual/virtualbox/setup/ubuntu/">Инсталляция VirtualBox в операционной системе Ubuntu в консоли</a>
	</li>
