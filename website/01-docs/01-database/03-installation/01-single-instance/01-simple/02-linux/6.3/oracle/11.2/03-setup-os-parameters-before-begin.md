---
layout: page
title: Инсталляция Oracle DataBase 11.2.0.3.2 в Oracle Linux 6.3 - Установка параметров ОС
description: Инсталляция Oracle DataBase 11.2.0.3.2 в операционной системе Oracle Linux 6.3 - Установка параметров ОС
keywords: Oracle DataBase 11.2, Oracle Linux 6.3, Установка параметров ОС
