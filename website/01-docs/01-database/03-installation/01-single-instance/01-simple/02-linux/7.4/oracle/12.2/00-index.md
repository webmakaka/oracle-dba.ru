...
### В последний раз инсталлировал по данной инструкции для тестовых задач 24.11.2017. (Необходимо поправить материал в настройках параметров ядра.)
...
Oracle linux можно скачать на сайте linux.oracle.com. Обращаю внимание, что кликать нужно на кнопку "Download" а не пытаться залогиниться.
