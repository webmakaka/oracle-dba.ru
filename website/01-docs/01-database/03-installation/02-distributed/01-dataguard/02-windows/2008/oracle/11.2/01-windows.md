...
После докатка логов переход в режим Snapshot, указывает путь к архивным файлам
...
// активация физического StandBy восстановление базы с помощью последних архивных логов на момент времени  
**to_PhStBy.bat**
...
// активация SnapShot StandBy c FlashBack  
**to_PhStBy.bat**
...
При внеочередном бэкапе пром базы необходимо скопировать архивлог для последующего восстановления при необходимости (с другим SID): (скрипт RestTest10Arch.sql)
