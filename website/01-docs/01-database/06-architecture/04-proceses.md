...
<div style="padding:10px; border:thin solid black;">
    ...
    Книга лежит в общем доступе уже более 4 лет и покупать ее сейчас особого смысла нет. Тем более, что книга была написана и переведена на русский очень давно. Последняя версия базы новее, чем 11.1.

    <br/>

    Покупать бумажные книги не рекомендую.

    <br/>

    Более того, если нужно что-то купить, а жаба душит. Есть сайт skladchik.com, на котором вы можете скинуться и разделить расходы на покупку между заинтересованными людьми. Некоторые согласны купить книгу и отсканировать ее.
...
Обязательные процессы запускаются при старте экземпляра и остаются активными на все время жизни экземпляра.
