...
<p>Табличное пространство Oracle является самым нижним логическим слоем структуры
  данных. Оно состоит из одного или более файлов данных. В ранних версиях СУБД
...
<blockquote>
  <p>- <b>DATAFILE file_specification</b> - определяет имена (или имя) файлов
    ...
    имени и первоначального размера в (К)илобайтах или в (М)гигабайтах файла данных.
