...
permalink: /database/installation/single-instance/simple/linux/6.3/oracle/12.1/enable-flashback-mod/
---

# <a href="/database/installation/single-instance/simple/linux/6.3/oracle/12.1/">[Инсталляция Oracle DataBase Server 11.2.0.3 в Oracle Linux 6.3]</a>: Включить режим работы FLASH BACK:
