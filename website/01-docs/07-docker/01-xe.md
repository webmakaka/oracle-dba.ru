...
Если вы работаете в Linux, то базу можно запустить парой команд. Под Windows docker тоже работает, но там не так очевидны преимущества, в силу того, что приходится использовать VirtualBox или VmWare как промежуточное звено виртуализации.
...
База данных Oracle бесплатной версии может быть запущена в контейнере парой команд. (Можно даже одной командой, не суть.)
...
<a href="https://gitops.ru/tools/containers/docker/setup/ubuntu/">ссылка</a>

**CentOS 7.3 like дистрибутивах:**

<a href="https://gitops.ru/tools/containers/docker/setup/centos/7/">ссылка</a>
