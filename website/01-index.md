...
P.S. Я уже достаточно давно перебрался в разработчики. Как следствие, я не прокачивал скиллы по администрированию достаточно долго, многое позабыл. Но в базовых вещах, все еще разбираюсь. Всем админам, которые скучают на работе, рекомендую попробовать себя в программировании. Как думаете какой язык я бы рекомендовал??? JavaScript - т.к. на нем можно программировать и на стороне браузера и на стороне сервера, программировать базы данных и разрабатывать мобильные приложения. Мой сайт по программированию на javascript находится <a href="//javadev.org">здесь</a>.
